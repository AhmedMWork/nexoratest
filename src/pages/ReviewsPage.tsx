      ...
      <div className="pt-24 pb-20 bg-[#050505] min-h-screen">
        <div className="w-full px-4 sm:px-6 lg:px-10">
          ...
          <SectionReveal delay={0.1}>
            <div className="grid sm:grid-cols-2 gap-6 p-6 bg-[#0b0b0d] border border-[#17171a] mb-10">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-xs text-[#8a8175]">Based on {reviews.length} reviews</p>
              </div>
          ...
          {isLoading ? (
            ...
            <div className="p-10 text-center text-xs text-[#8a8175] bg-[#0b0b0d] border border-[#17171a]">No customer reviews have been published yet.</div>
          )}
        </div>
      </div>
    </>
