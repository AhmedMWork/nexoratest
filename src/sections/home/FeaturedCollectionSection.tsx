  ...
  return (
    <section className="py-20 lg:py-32 bg-[#0a0a0a]">
      <div className="w-full px-4 sm:px-6 lg:px-10">
        <SectionReveal>
          <p className="nexora-caption text-[#ffaa33] mb-3">Curated Selection</p>
        ...
        <div className="grid lg:grid-cols-7 gap-4">
          ...
          <SectionReveal className="lg:col-span-4" delay={0.1}>
            <Link
              ...
              className="group relative block aspect-[4/5] lg:aspect-auto lg:h-[700px] overflow-hidden bg-[#121212] border border-[#1e1e1e] hover:border-[#333] transition-all"
            >
              <img
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-[#f3f3f3] mb-2 group-hover:text-[#ffaa33] transition-colors">
                  {mainProduct.name}
                </h3>
              ...
              <div className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center bg-[#ffaa33] text-[#0a0a0a] opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {sideProducts.map((product, i) => (
              <SectionReveal key={product.slug} delay={0.2 + i * 0.1}>
                <Link
                  ...
                  className="group relative block h-full min-h-[250px] overflow-hidden bg-[#121212] border border-[#1e1e1e] hover:border-[#333] transition-all"
                >
                  <img
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <p className="text-[10px] tracking-[0.2em] uppercase text-[#ffaa33] mb-1">
                      {product.collection}
                    </p>
                    <h3 className="text-lg font-bold text-[#f3f3f3] group-hover:text-[#ffaa33] transition-colors">
                      {product.name}
                    </h3>
